# 2026-01-10 16:59:16 by RouterOS 7.18.2
...
set 1 name=serial1
/queue type
add kind=pcq name=PCQ-download pcq-classifier=dst-address pcq-rate=768k
add kind=pcq name=pcq-Upload pcq-classifier=src-address pcq-rate=768k
/queue simple
add max-limit=2M/2M name=queue1 queue=pcq-Upload/PCQ-download target=""
